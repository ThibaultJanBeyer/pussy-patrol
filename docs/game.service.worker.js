...
/** @type {string} */
const CACHE_VERSION = '1788621475|24664321127';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["index.html","game.js","game.offline.html","game.icon.png","game.apple-touch-icon.png","game.audio.worklet.js","game.audio.position.worklet.js","favicon.ico","game.png","game.144x144.png","game.180x180.png","game.512x512.png"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["game.wasm.gz","game.pck"];
